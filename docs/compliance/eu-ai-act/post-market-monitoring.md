...
- **Verification Regression Harnesses:** Run CI regression suites (`pnpm run test`) across golden-set fixtures for TypeScript and Python (`ADR-036`, `ADR-044`) on every commit and release.
